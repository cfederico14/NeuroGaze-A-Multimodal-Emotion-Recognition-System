...
class NumpyDataLoader(Sequence):
    ...
    train_loader = NumpyDataLoader(data_dir="C:/Users/carmi/Desktop/Biometria/SEED_IV Database/SEED_IV Database/splittati/train", batch_size=128, mean=mean, std=std, preprocess=True)
    ...
    def train(model, optimizer, loss_fn, train_loader, epochs):
        for epoch in range(epochs):
            ...
            for batch_data, batch_labels in train_loader:
                ...
                batch_accuracy = model.calculate_accuracy(batch_labels, logits)
    ...
    train(model, optimizer, loss_fn, train_loader, 1)

data_loader = NumpyDataLoader(data_dir="C:/Users/carmi/Desktop/Biometria/SEED_IV Database\SEED_IV Database/dati", batch_size=62)
...
# Aggiunta dei layer convoluzionali
model.add(Conv2D(32, (3, 3), activation='relu', input_shape=(62, 64, 20)))
model.add(MaxPooling2D((2, 2)))
model.add(Conv2D(64, (3, 3), activation='relu'))
model.add(MaxPooling2D((2, 2)))
...
model.add(Dense(128, activation='relu'))
model.add(Dense(len(data_loader.class_list), activation='softmax'))
